        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductDetail_Ban_BanId",
                        column: x => x.BanId,
                        principalTable: "Ban",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductDetail_Brand_BrandId",
                        column: x => x.BrandId,
                        principalTable: "Brand",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductDetail_City_CityId",
                        column: x => x.CityId,
                        principalTable: "City",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductDetail_Engine_EngineId",
                        column: x => x.EngineId,
                        principalTable: "Engine",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductDetail_Fuel_FuelId",
                        column: x => x.FuelId,
                        principalTable: "Fuel",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductDetail_Gear_GearId",
                        column: x => x.GearId,
                        principalTable: "Gear",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductDetail_Transmission_TransmissionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductParam", x => new { x.ParamId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_ProductParam_Param_ParamId",
                        column: x => x.ParamId,
                        principalTable: "Param",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductParam_Product_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductParam_ProductDetail_ProductDetailId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductDetail_EngineId",
                table: "ProductDetail",
                column: "EngineId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductDetail_FuelId",
                table: "ProductDetail",
                column: "FuelId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductDetail_GearId",
                table: "ProductDetail",
                column: "GearId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductDetail_TransmissionId",
                table: "ProductDetail",
                column: "TransmissionId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductParam_ProductDetailId",
                table: "ProductParam",
                column: "ProductDetailId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductParam_ProductId",
                table: "ProductParam",
                column: "ProductId");
        }
