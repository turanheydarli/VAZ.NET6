...
namespace WebAPI.Controllers
{
    ...
    public class BaseApiController : Controller
    {
		...
		[ApiExplorerSettings(IgnoreApi = true)]
		public IActionResult GetResponseOnlyResult(VAZ.Shared.Utilities.Results.IResult result)
		{
			return result.Success ? Ok(result) : BadRequest(result);
		}

		[ApiExplorerSettings(IgnoreApi = true)]
		public IActionResult GetResponseOnlyResultMessage(VAZ.Shared.Utilities.Results.IResult result)
		{
